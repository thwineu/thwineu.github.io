...
> 
> I am a Data Scientist and Civil Industrial Engineer specializing in machine learning, artificial intelligence, and strategic data analysis/business analytics. I identify pain points and build system[...]  
...
* **USE OF LARGE LANGUAGE MODELS TO IDENTIFY EMPATHY (M.Sc. Thesis):** Researched and developed an artificial intelligence model pipeline to analyze and detect empathy markers, successfully defended i[...]  
...
<footer style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; font-size: 0.9em; padding-top: 10px; color: #606c71;">
  <div style="margin-bottom: 15px; flex: 1; min-width: 250px;">
    ...
    <details>
      ...
      <p style="margin-top: 10px; font-size: 0.9em;">
        ...
        <a href="https://github.com/pages-themes/cayman">cayman is maintained by <a href="https://github.com/pages-themes">pages-themes</a></a>. | 
  ...
  <div style="display: flex; flex-direction: column; gap: 15px; align-items: flex-end; flex: 1; min-width: 200px;">
    <p style="margin: 0; font-weight: bold;">Let's Connect</p>
