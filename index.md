...
<footer style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-start; font-size: 0.9em; padding-top: 20px; color: #606c71; border-top: 1px solid #eff0f1; margin-top: 2rem;">
...
<span style="margin: 0; font-weight: bold;">&copy; 2026 Thomas Winkler</span>
</div>
<details>
...
<div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center; justify-content: flex-end; flex: 2; min-width: 300px; height: 24px;">
